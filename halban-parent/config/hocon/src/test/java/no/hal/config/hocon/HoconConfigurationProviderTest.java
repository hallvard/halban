...
public class HoconConfigurationProviderTest {
    
    private ConfigurationProvider settingsProvider = new HoconConfigurationProvider();
    ...
    @Test
    public void testJsonConfigurationProvider() throws IOException {
        Setting.Object settings = settingsProvider.loadConfiguration(new ByteArrayInputStream(hocon.getBytes(StandardCharsets.UTF_8)));
