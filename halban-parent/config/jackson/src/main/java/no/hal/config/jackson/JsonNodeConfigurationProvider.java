...
import no.hal.config.SettingImpl;
import no.hal.config.ConfigurationProvider;

public abstract class JsonNodeConfigurationProvider implements ConfigurationProvider {
    ...
    protected JsonNodeConfigurationProvider(ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }
    protected JsonNodeConfigurationProvider(JsonFactory jsonFactory) {
        this(new ObjectMapper(jsonFactory));
    }
    protected JsonNodeConfigurationProvider() {
        this(globalObjectMapper);
    }

    @Override
    public Setting.Object loadConfiguration(InputStream input) throws IOException {
