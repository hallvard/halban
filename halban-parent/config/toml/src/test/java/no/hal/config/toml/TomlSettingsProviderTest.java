...
public class TomlSettingsProviderTest {
    ...
    private ConfigurationProvider settingsProvider = new TomlConfigurationProvider();
    ...
    public void testJsonConfigurationProvider() throws IOException {
        Setting.Object settings = settingsProvider.loadConfiguration(new ByteArrayInputStream(toml.getBytes(StandardCharsets.UTF_8)));
