...
public class HoconSettingsProviderTest {
    
    private SettingsProvider settingsProvider = new HoconSettingsProvider();
    ...
    public void testJsonSettingsProvider() throws IOException {
        Setting.Object settings = settingsProvider.loadSettings(new ByteArrayInputStream(hocon.getBytes(StandardCharsets.UTF_8)));
