...
public class YmlSettingsProviderTest {
    
    private SettingsProvider settingsProvider = new YmlSettingsProvider();
    ...
    public void testJsonSettingsProvider() throws IOException {
        Setting.Object settings = settingsProvider.loadSettings(new ByteArrayInputStream(yaml.getBytes(StandardCharsets.UTF_8)));
